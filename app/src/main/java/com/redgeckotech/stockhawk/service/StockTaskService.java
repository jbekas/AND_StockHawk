...
import com.redgeckotech.stockhawk.rest.SymbolNotFoundException;
...
public class StockTaskService extends GcmTaskService {
    ...
    public int onRunTask(TaskParams params) {
        ...
        try {
            ...
            Timber.d(e, "Caught SymbolNotFoundException");
            rxBus.send(new SymbolNotFoundEvent(e.getMessage()));
        } catch (IOException e) {
            e.printStackTrace();
        }
